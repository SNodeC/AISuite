...
namespace ai::openai::codex::bridge {
    ...
    bool CodexBridge::observerMethodIsReadOnly(std::string_view method) const {
        static constexpr std::array exactMethods{
            std::string_view{"account/bedrock/discover"},
            ...
            std::string_view{"environment/status"},
            std::string_view{"experimentalFeature/list"},
            std::string_view{"externalAgentConfig/import/readHistories"},
            ...
            std::string_view{"remoteControl/client/list"},
            std::string_view{"remoteControl/status/read"},
            std::string_view{"server/diagnostics"},
            ...
            std::string_view{"thread/search"},
            std::string_view{"thread/searchOccurrences"},
            std::string_view{"thread/timeline/list"},
            std::string_view{"thread/turns/list"},
            std::string_view{"threadSection/list"},
            std::string_view{"userVerification/status"},
