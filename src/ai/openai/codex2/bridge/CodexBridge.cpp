...
namespace ai::openai::codex2::bridge {
    ...
    std::string CodexBridge::nextLocalRequestId() {
        std::string id;
        do {
            id = "codex2-local-" + std::to_string(providerGeneration_) + '-' + std::to_string(nextLocalRequestNumber_++);
    ...
    std::string CodexBridge::nextFrontendRequestId(std::string_view connectionId) {
        ...
        std::string key;
        do {
            id = "codex2-remote-" + std::to_string(providerGeneration_) + '-' + std::string(connectionId) + '-' +
