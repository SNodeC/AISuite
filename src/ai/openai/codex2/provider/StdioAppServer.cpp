...
#include "ai/openai/codex2/provider/ChildExitObserver.h"
...
namespace ai::openai::codex2::provider {
    ...
    bool StdioAppServer::start() {
        ...
        core::pipe::Pipe stdinPipe(O_CLOEXEC, "codex2-appserver-stdin");
        core::pipe::Pipe stdoutPipe(O_CLOEXEC, "codex2-appserver-stdout");
        core::pipe::Pipe stderrPipe(O_CLOEXEC, "codex2-appserver-stderr");
