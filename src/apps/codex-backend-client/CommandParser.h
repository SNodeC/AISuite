...
namespace apps::codex_backend_client {
    ...
    struct ReconnectCommand {
        bool operator==(const ReconnectCommand&) const = default;
    };
    ...
    using ParsedCommand =
        std::variant<NoopCommand, HelpCommand, QuitCommand, ReconnectCommand, WatchCommand, RemoteCommand, NewCommand, CommandParseError>;
