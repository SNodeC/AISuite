...
The Codex libraries use SOVERSION 7 after the public frontend API gained an
explicit authoritative `thread.read` state effect. The compact canonical
mutation records preserve Frontend Protocol v1. A1.6a
