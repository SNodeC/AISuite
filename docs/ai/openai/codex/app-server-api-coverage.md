...
| Typed wire request/result coverage | 85/87 | 97.7% | Stable client requests; includes typed initialization lifecycle support. |
| Typed notification/server-request coverage | 67/78 | 85.9% | Stable server notifications and server-initiated requests. |
