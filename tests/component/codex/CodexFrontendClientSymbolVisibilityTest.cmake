if(NOT DEFINED AISUITE_FRONTEND_CLIENT_LIBRARY OR
   NOT EXISTS "${AISUITE_FRONTEND_CLIENT_LIBRARY}")
...
if(NOT nm_result EQUAL 0)
    message(FATAL_ERROR "unable to inspect frontend-client exports: ${nm_error}")
endif()
...
foreach(forbidden
    ...
    if(NOT forbidden_index EQUAL -1)
        message(FATAL_ERROR "private frontend-client symbol is exported: ${forbidden}")
    endif()
endforeach()
...
foreach(public_class IN LISTS public_classes)
    set(qualified
        "ai::openai::codex::frontend::client::${public_class}::"
    )
    string(FIND "${symbols}" "${qualified}" public_index)
    if(public_index EQUAL -1)
        message(FATAL_ERROR "public frontend-client class has no exported symbol: ${public_class}")
    endif()
endforeach()
