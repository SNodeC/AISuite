...
if(NOT archive_name MATCHES "^AISuite-0[.]4[.]0(-[^/]*)?[.]tar[.]gz$")
    message(
        FATAL_ERROR
            "unexpected AISuite 0.4.0 binary archive name ${archive_name}"
    )
endif()
execute_process(
...
set(required_package_entries
    ...
    "lib/libaisuite-openai-codex.so.5"
    "lib/libaisuite-openai-codex-backend.so.5"
...
set(forbidden_package_entries
    ...
    "lib/libaisuite-openai-codex.so.4"
    "lib/libaisuite-openai-codex-backend.so.4"
    "lib/libaisuite-openai-codex-frontend-protocol.so.4"
    "lib/libaisuite-openai-codex-frontend.so.4"
    "lib/libaisuite-openai-codex-frontend-client.so.4"
