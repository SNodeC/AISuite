...
#if defined(AISUITE_CODEX2_TEST_WEBSOCKET_TLS)
    ...
    int runLoopback(char* argv[],
        ...
        int eventLoopResult = 1;
        {
            ...
            client::ClientConnection connection(
                ...
                {.onConnected =
                     [&scenario] {
                         tests::codex2::traceCommunication(name(scenario.transport), "websocket-binding", "lifecycle", "connected");
                         ++scenario.connected;
                     },
                 .onDisconnected =
                     [&scenario] {
                         tests::codex2::traceCommunication(name(scenario.transport), "websocket-binding", "lifecycle", "disconnected");
            ...
            WebApp webApp("codex2-websocket-transport-server");
            ...
            HttpClient httpClient("codex2-websocket-transport-client", beginUpgrade, endHttp, binding);
